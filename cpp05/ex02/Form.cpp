...
Form::Form() : _name("Form"), _signed(0), _signGrade(150), _executeGrade(150), _target("") {}

Form::Form(const std::string name, int signGrade, int executeGrade, const std::string target) : _name(name), _signed(0), _signGrade(signGrade), _executeGrade(executeGrade), _target(target) {
